...
function animate(){
    ...
    platforms.forEach(platform => {
        ...
        platform.update()
           if(player.x + player.radius <= platform.x + platform.width && player.x - player.radius >= platform.x && platform.y -10 <= player.y + player.radius && player.y - player.radius <= platform.y + platform.height )
            { 
                player.y=platform.y-player.radius
                player.yVelocity=-platform.yVelocity
            }
