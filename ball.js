...
function animate(){
    ...
    platforms.forEach(platform => {
        ...
        platform.update()
           if(player.x <= platform.x + platform.width && player.x >= platform.x && platform.y <= player.y + player.radius && player.y + player.radius <= platform.y + 100  && player.y - player.radius <= platform.y + platform.height )
            { 
                player.yVelocity=-platform.yVelocity-2
            }
